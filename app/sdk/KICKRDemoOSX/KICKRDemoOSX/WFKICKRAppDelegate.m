...
//    }
    ...
    // set the device type, wildcard and proximity check boxes based on whether the hardware connector
    ...
    if (!params | (params.sensorSubType!=WF_SENSOR_SUBTYPE_BIKE_POWER_KICKR_SNAP) )
    {
        self.kickrSnapCheckBox.state = NSOffState;
    }
    else
    {
        self.kickrSnapCheckBox.state = NSOnState;
    }
...
- (WFConnectionParams*) connectionParams
{
    ...
    if ( self.wildcardCheckBox.state == NSOnState )
    {
        ...
        params.sensorSubType = (self.kickrSnapCheckBox.state == NSOnState) ? WF_SENSOR_SUBTYPE_BIKE_POWER_KICKR_SNAP : WF_SENSOR_SUBTYPE_BIKE_POWER_KICKR;
